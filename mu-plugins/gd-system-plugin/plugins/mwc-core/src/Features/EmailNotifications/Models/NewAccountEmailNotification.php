...
class NewAccountEmailNotification extends EmailNotification implements WooCommerceEmailNotificationContract
{
    ...
    protected function getMainContentHtml() : string
    {
        ...
        <p><?php printf(
                ...
                esc_html__('Hi %s,', 'mwc-core'),
                esc_html(stripslashes($wcEmail->user_login))
            ); ?></p>
        <p><?php printf(
                /* translators: %1$s: Site title, %2$s: Username, %3$s: My account link */
                esc_html__('Thanks for creating an account on %1$s. Your username is %2$s. You can access your account area to view orders, change your password, and more at: %3$s', 'mwc-core'),
        ...
        <p><?php printf(
                ...
                esc_html__('Your password has been automatically generated: %s', 'mwc-core'),
