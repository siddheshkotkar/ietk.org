 ...
 */
class GiftCertificateInterceptor implements InterceptorContract
{
    /**
     * {@inheritDoc}
     *
    ...
    /**
     * Gets the new gift certificate flag instance for the given id.
     *
     * @param int $giftCertificateId
     * @return NewWooCommerceObjectFlag
     */
    protected function getNewGiftCertificateFlag(int $giftCertificateId) : NewWooCommerceObjectFlag
    {
        return new NewWooCommerceObjectFlag($giftCertificateId);
    }
    ...
    {
        $flag = $this->getNewGiftCertificateFlag($giftCertificate->getId());
